...
\033[1;97m      @@@•••••••••••••••••••••••••@@@ \033[1;0m
\033[1;97m--------------------------------------------------
\033[1;93m➤\033[1;97m Author   : IMTIAZ~ARADIN
\033[1;93m➤\033[1;97m Github   : https://github.com/Aradin110
...
def tech_abm():
    ...
    if username =="IMTIAZ":
        os.system("clear")
        print logo
        print ("[+] Username : IMTIAZ (Correct)")
        passwordss = raw_input("\033[1;97m[+]\033[1;97m Password :\033[1;97m ")
        if passwordss =="ARADIN":
            os.system("clear")
            print logo
            logging()
            os.system("clear")
            print logo 
            print ("\033[1;97m[+]\033[1;92m Username : IMTIAZ\033[1;92m (Correct)")
            print ("\033[1;97m[+]\033[1;92m Password : ARADIN\033[1;92m (Correct)")
	    print("\033[1;97m--------------------------------------------------")
            time.sleep(1)
            print('')
